...
export const ListInventoryResponseItem = zod.object({
  ...
  "minStock": zod.number(),
  "unit": zod.string(),
  "servings": zod.number().nullable().describe('Reicht noch für ca. X Portionen (kleinste Portionszahl über alle Rezepte mit dieser Zutat)'),
  "servingsProduct": zod.string().nullable().describe('Produktname zur Portions-Schätzung'),
...
export const CreateStockItemBody = zod.object({
  ...
  "unit": zod.enum(['Stück', 'kg', 'g', 'Liter', 'ml', 'Packung']).optional(),
  "purchasePrice": zod.number().nullish(),
  "supplier": zod.string().nullish(),
  "active": zod.boolean().optional(),
