...
export default function AdminSettings() {
  ...
  const handleSaveInfo = () => {
    updateSettings.mutate(
      { data: form },
      {
        onSuccess: () => { qc.invalidateQueries({ queryKey: getGetRestaurantInfoQueryKey() }); toast({ title: "Settings saved" }); },
  ...
  const handleChangePassword = () => {
    setPwError("");
    if (!pwForm.newPassword) { setPwError("New password required"); return; }
    ...
    updateSettings.mutate(
      ...
      {
        onSuccess: () => { toast({ title: "Password changed" }); setPwForm({ newPassword: "", confirmPassword: "" }); },
  ...
  return (
    <AdminLayout>
      <div className="mb-6">
        <h1 className="text-3xl font-display font-bold uppercase text-white">Settings</h1>
        <p className="text-muted-foreground mt-1">Configure your restaurant details.</p>
      </div>
        ...
        <div className="space-y-6 max-w-2xl">
          <div className="bg-card border border-border p-6">
            <div className="flex items-center gap-2 mb-6">
              ...
              <h2 className="font-display font-bold uppercase text-white">Restaurant Info</h2>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                { label: "Restaurant Name", key: "restaurantName" as const },
              ...
              <div className="md:col-span-2">
                <label className="text-xs text-muted-foreground uppercase tracking-wider mb-1 block">Address</label>
          ...
          <div className="bg-card border border-border p-6">
            <div className="flex items-center gap-2 mb-6">
              ...
              <h2 className="font-display font-bold uppercase text-white">Change Password</h2>
            </div>
