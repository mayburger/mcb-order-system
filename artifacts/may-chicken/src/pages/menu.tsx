    ...
    <Layout>
      <div className="bg-card py-12 border-b border-border">
        <div className="container mx-auto px-4">
          <h1 className="text-5xl md:text-6xl font-display font-bold uppercase tracking-tight text-white">Unsere Speisekarte</h1>
        </div>
      </div>
                      ...
                      <div key={item.id} className="group bg-card border border-border overflow-hidden flex flex-col hover:border-primary/50 transition-colors">
                        ...
                        <div className="p-6 flex-1 flex flex-col">
                          ...
                          >
                            {item.available ? (
                              <>
                                <ShoppingBag className="mr-2 h-4 w-4" /> Hinzufügen
                              </>
                            ) : (
                              "Ausverkauft"
                            )}
